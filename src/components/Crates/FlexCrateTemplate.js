...
class FlexCrateTemplate extends Component {
  ...
  render() {
    ...
    if (type === 'empty') {
      ...
      previewVar = <div className="emojiContainer" style={styles.emojiContainer}><CrateEmojis color={eval(color).darkColor} visible={'1'}/></div>
      profileImage = null;
    } else if (type === 'profile') {
      ...
      previewVar = <div className="crateIcon" style={styles.crateIcon}><SettingsIcon color={colors(color).darkColor} /></div>
      profileImage = null;
    } else if (type === 'settings-block') {
      previewVar = <div className="crateIcon" style={styles.crateIcon}><MuteIcon color={colors(color).darkColor} /></div>
      profileImage = null;
    } else if (type === 'settings-unblock') {
      previewVar = <div className="crateIcon" style={styles.crateIcon}><PlayIcon color={colors(color).darkColor} /></div>
      profileImage = null;
    } else if (type === 'settings-follow') {
      previewVar = <div className="crateIcon" style={styles.crateIcon}><FollowIcon color={colors(color).darkColor} /></div>
      profileImage = null;
    } else if (type === 'settings-logout') {
      previewVar = <div className="crateIcon" style={styles.crateIcon}><LogoutIcon color={colors(color).darkColor} /></div>
      profileImage = null;
    }
