...
const CrateList = ({onDelete, item, index, itemsLength, color}) => {
  ...
  return <CrateTemplate id={item.key} crateSize={80} onDelete={onDelete} color={item.crateColor} cratePreview={item.image} shadow={'true'} crateType={'normal'} popType={'1'} pop={'true'} />
}
