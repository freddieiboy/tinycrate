              ...
              { this.state.isPressed ? (
                ...
                <div className="crate0">
                  <svg viewBox="0 0 157 164" version="1.1">
                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                      <rect id="crate-bottom" fill={colorDark} x="0" y="36.2828685" width="157" height="126.717131" rx="26"></rect>
                      <rect id="crate-top" fill={colorLight} x="0" y="0" width="157" height="107.641434" rx="26"></rect>
                    </g>
                  </svg>
